...
public class KTPages {
	...
	public static void takeSnapShot(WebDriver webdriver, String Pagename) throws Exception{
		...
		File DestFile=new File("C:\\Users\\praveenkumar\\Downloads\\MyAutomation\\selenium-server-3.141.59\\Screnshots\\KTpages"+ Pagename + Math.random()+".jpg");
